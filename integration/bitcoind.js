...
var Random = PACGlobal.crypto.Random;
...
// These tests require a running pacglobald instance
describe('Integration with ' + network.name + ' pacglobald', function() {
