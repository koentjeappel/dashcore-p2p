...
function builder(options) {
  ...
  if (!options.network) {
    options.network = PACGlobal.Networks.defaultNetwork;
  }

  options.Block = options.Block || PACGlobal.Block;
  options.BlockHeader = options.BlockHeader || PACGlobal.BlockHeader;
  options.Transaction = options.Transaction || PACGlobal.Transaction;
  options.MerkleBlock = options.MerkleBlock || PACGlobal.MerkleBlock;
  options.MnListDiff = options.MnListDiff || PACGlobal.MnListDiff;
